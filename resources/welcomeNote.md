## Welcome to Electron-Note 👋🏻

Electron-Note is a simple **note-taking app** that uses **Markdown** syntax to format your notes.
...
Here are all the heading formats currently supported by **_Electron-Note_**:
